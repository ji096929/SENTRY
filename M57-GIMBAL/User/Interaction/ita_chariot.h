...
protected:
    ...
    uint32_t Chassis_Flag = 0;
    uint32_t Pre_Chassis_Flag = 0;
    ...
    float DR16_Yaw_Angle_Resolution = 0.008f * PI * 57.29577951308232*1.5;
    //DR16云台pitch灵敏度系数(0.001PI表示pitch速度最大时为1rad/s)
    float DR16_Pitch_Angle_Resolution = 0.0035f * PI * 57.29577951308232*1.5;

    //DR16云台yaw灵敏度系数(0.001PI表示yaw速度最大时为1rad/s)
    float DR16_Yaw_Resolution = 0.003f * PI;
    //DR16云台pitch灵敏度系数(0.001PI表示pitch速度最大时为1rad/s)
    float DR16_Pitch_Resolution = 0.003f * 12;
